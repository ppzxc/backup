...
pub struct I18nMessages {
    ...
    pub sftp_test_failed_action: &'static str,
    pub sftp_action_retry: &'static str,
    pub sftp_action_reenter: &'static str,
    pub sftp_action_change_key: &'static str,
    pub sftp_action_ignore: &'static str,
    pub sftp_action_cancel: &'static str,
    ...
    pub fn get(lang: Language) -> Self {
        match lang {
            Language::Ko => Self {
                ...
                sftp_test_failed_action: "SFTP 접속 테스트에 실패했습니다. 어떻게 진행하시겠습니까?",
                sftp_action_retry: "[1] 동일한 정보로 접속 재시도",
                sftp_action_reenter: "[2] SFTP 호스트/계정 정보 다시 입력",
                sftp_action_change_key: "[3] SSH Key 다시 선택 또는 재생성",
                sftp_action_ignore: "[4] 경고 무시하고 설정 계속 진행",
                sftp_action_cancel: "[5] Setup 중단",
            ...
            Language::En => Self {
                ...
                sftp_test_failed_action: "SFTP connection test failed. How would you like to proceed?",
                sftp_action_retry: "[1] Retry connection with same parameters",
                sftp_action_reenter: "[2] Re-enter SFTP host/credentials",
                sftp_action_change_key: "[3] Re-select or regenerate SSH key",
                sftp_action_ignore: "[4] Ignore warning and proceed anyway",
                sftp_action_cancel: "[5] Abort setup",
