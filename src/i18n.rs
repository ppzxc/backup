    ...
    pub fn get(lang: Language) -> Self {
        match lang {
            Language::Ko => Self {
                ...
                sftp_action_ignore: "[3] 경고 무시하고 설정 계속 진행",
                sftp_action_cancel: "[4] Setup 중단",
            ...
            Language::En => Self {
                ...
                sftp_action_ignore: "[3] Ignore warning and proceed anyway",
                sftp_action_cancel: "[4] Abort setup",
